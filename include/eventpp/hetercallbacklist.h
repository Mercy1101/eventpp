...
class HeterCallbackListBase {
 protected:
  ...
  template <typename T>
  class HomoCallbackListType : public CallbackList<T, UnderlyingPoliciesType_>,
   ...
   public:
    ...
    virtual bool doRemove(const HeterHandle_& handle) override {
      ...
      return this->remove(typename super::Handle(
          std::static_pointer_cast<typename super::Handle::element_type>(sp)));
    }
 ...
 public:
  ...
  Handle insert(const C& callback, const Handle& before) {
    ...
    return Handle{
        PrototypeInfo::index,
        callbackList->insert(
            callback, UnderlyingHandle(std::static_pointer_cast<
  ...
  void forEach(Func&& func) const {
    ...
    callbackList->forEach([this, &func](const typename CL::Handle& handle,
